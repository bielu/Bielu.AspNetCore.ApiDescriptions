...
| `Bielu.Cli.Shared` | Shared console-CLI infrastructure (logging, argument parsing, file globbing, validate/diff report formatting) used by both `dotnet-asyncapi` and `dotnet-arazzo` |
