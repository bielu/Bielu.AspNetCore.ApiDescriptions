...
public class MessageAttribute(Type payloadType, params string[] tags) : Attribute
{
    public MessageAttribute(Type payloadType) : this(payloadType, Array.Empty<string>())
    {
    }
