...
{
    /// <summary>
    /// The default CDN URL for the published <c>@bielu/scalar-signalr-standalone</c> full bundle. Pinned to the
    ...
    /// standalone bundle (Scalar + the SignalR console in one script), not <c>dist/plugin.js</c>:
    ...
    public const string DefaultBundleUrl =
        "https://cdn.jsdelivr.net/npm/@bielu/scalar-signalr-standalone@" + ScalarPluginBundleVersion.Value + "/index.js";
