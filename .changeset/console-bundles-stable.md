---
"@bielu/scalar-signalr": major
"@bielu/scalar-grpc": major
---

release the SignalR and gRPC console bundles as stable `1.0.0`, aligned with the NuGet suite version.
...
— a version published *before* the pluginUrls migration, whose tarball contains no
